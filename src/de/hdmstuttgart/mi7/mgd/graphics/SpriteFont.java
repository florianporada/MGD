...
public class SpriteFont {
    ...
    public SpriteFont(GraphicsDevice graphicsDevice, Typeface typeface, float size){
        ...
        material.setTextureWrapMode(TextureWrapMode.CLAMP, TextureWrapMode.CLAMP);
        material.setBlendFactor(BlendFactor.SRC_ALPHA, BlendFactor.ONE_MINUS_SRC_ALPHA);
    ...
    public void setCharacterInfos(Map<Character, CharacterInfo> characterInfos) {
